	...
	MOST IMPORTANT METHODS
		...
		MANAGEMENT (Dealing with connections, errors, etc.)
			...
			debug()				- Debug mode. Verbose errors. DO NOT USE FOR PRODUCTION. 
								  ...
								  Terminates the script whenever a database error is encountered.
...
*/
	...
	class dbLink {
		...
		public function __construct() {
			// OPTIONAL SYNTAX - (dbUser, [dbPassword], [dbHost], [sphinx] )
			if(func_num_args() > 0) {
...
//			$this->link = mysql_connect($this->_dbHost, $this->_dbUser, $this->_dbPassword, false, 65536 );
		...
		public function getArray($sql) {
			# RETURNS
				...
				# An empty array if no records match (so count(result) will = 0)
...
#			}
		...
		public function queriesCached() {
			return $this->_queryCountCached;
		}
